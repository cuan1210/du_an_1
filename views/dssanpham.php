...
<style>
  ...
  @media (max-width: 1024px) {
    main {
      ...
      align-items: center;
      margin: 0 50px; /* Cách lề 50px khi màn hình nhỏ hơn */
    }
  ...
  @media (max-width: 768px) {
    main {
      margin: 0 20px; /* Cách lề 20px khi màn hình nhỏ hơn */
    }
    .product-list {
      grid-template-columns: repeat(2, 1fr);
    }
  ...
  @media (max-width: 480px) {
    main {
      margin: 0 10px; /* Cách lề 10px trên mobile */
    }
    .product-list {
